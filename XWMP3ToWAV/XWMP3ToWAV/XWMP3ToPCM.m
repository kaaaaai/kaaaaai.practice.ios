...
//  XWMP3ToWAV
//
//  Created by luyonghe on 2017/3/13.
...
+ (void)mp3ToPcmWithMp3FilePath:(NSString *)mp3FilePath pcmFilePath:(NSString *)pcmFilePath complete:(void (^)(void))complete{
   ...
   // 3.配置转码参数
    ...
    [outputSettings setValue:[NSNumber numberWithFloat:16000.0] forKey:AVSampleRateKey];
    [outputSettings setValue:[NSNumber numberWithInt:1] forKey:AVNumberOfChannelsKey];
